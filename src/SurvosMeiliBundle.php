                    ...
                    ->arrayNode('workspaces')
                        ...
                        ->arrayPrototype()
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('curatorName')
                                    ->defaultNull()
                                    ->info('Optional explicit curator display name for this workspace template')
                                ->end()
                                ->arrayNode('curatorNameByIndex')
                                    ->info('Optional curator display name overrides keyed by base index name (e.g. movie, wam)')
                                    ->scalarPrototype()->end()
                                    ->defaultValue([])
                                ->end()
                                ...
                                ->arrayNode('examples')
                                    ...
                                    ->defaultValue([])
                                ->end()
                                ->arrayNode('examplesByIndex')
                                    ->info('Optional example query overrides keyed by base index name')
                                    ->arrayPrototype()
                                        ->scalarPrototype()->end()
                                    ->end()
                                    ->defaultValue([])
